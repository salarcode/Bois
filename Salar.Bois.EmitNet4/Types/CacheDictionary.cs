...
//{
//	class CacheDictionary2
//	{
//	}
// 	public class CacheDictionary : IDictionary//, ISerializable, IDeserializationCallback, ICloneable
//	{
...
//		// 
//		public CacheDictionary(int capacity) : this(capacity, 1.0f)
//		{
//		}
...
//		// 
//		public CacheDictionary(int capacity, float loadFactor)
//		{
//			if (capacity < 0)
...
//		public CacheDictionary(int capacity, float loadFactor, IEqualityComparer equalityComparer) : this(capacity, loadFactor)
//		{
//			_keycomparer = equalityComparer;
//		}


//		public CacheDictionary(IEqualityComparer equalityComparer) : this(0, 1.0f, equalityComparer)
//		{
//		}

//		public CacheDictionary(int capacity, IEqualityComparer equalityComparer)
...
//		// 
//		public CacheDictionary(IDictionary d) : this(d, 1.0f)
//		{
//		}
...
//		// 
//		public CacheDictionary(IDictionary d, float loadFactor)
//			: this(d, loadFactor, (IEqualityComparer)null)
//		{
//		}

 
//		public CacheDictionary(IDictionary d, IEqualityComparer equalityComparer)
...
//		public CacheDictionary(IDictionary d, float loadFactor, IEqualityComparer equalityComparer)
